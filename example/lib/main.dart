                ...
                child: Container(
                    ...
                    child: Text(str,
                        style: const TextStyle(
                            fontSize: 12.0, color: Color.fromARGB(255, 251, 255, 9)))));
          }).toList(),
        ],
      ));
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          child: CSSFilter.blur(value: 0.0, child: Container(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  ClipRect(
                    child: CSSFilter.blur(child: pic('blur(1.5)'), value: 1.5),
                  ),
                  ...
                  CSSFilter.apply(
                      ...
                      value: CSSFilterMatrix().hueRotate(60.0).grayscale(0.5)),
                  // CSSFilter.apply(
                  //     child: pic('brightness(1.2),saturate(0.8),hueRotate(20.0)'),
                  //     value: CSSFilterMatrix().brightness(1.2).saturate(0.8).hueRotate(20.0)),
                  CSSFilter.apply(
                      child: pic('contrast(1.2),sepia(0.8),hueRotate(90.0),invert(0.9),opacity(0.9)'),
                  ...
                  CSSFilterPresets.insNashvilleV2(child: pic('insNashvilleV2')),
                  ...
                  CSSFilterPresets.apply(
                    child: Opacity(opacity: 0.7, child: pic( 'apply ins1977 alphaBlending')),
